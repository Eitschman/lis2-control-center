    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ["de"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Allgemein",
                ["Media"]="Medien", ["Windows 11 media session"]="Windows-11-Mediensitzung", ["Integrated directly with Windows"]="Direkt über Windows integriert", ["Create playback page"]="Wiedergabeseite erstellen", ["Winamp plug-in"]="Winamp-Plug-in", ["Page variables"]="Seitenvariablen",
                ["Windows Media Player"]="Windows Media Player",
                ["Windows Media Now Playing"]="Windows Media – Aktuelle Wiedergabe",
                ["Windows media session"]="Windows-Mediensitzung",
                ["No plug-in is required; telemetry comes directly from Windows GSMTC."]="Kein Plug-in erforderlich; die Telemetrie kommt direkt von Windows GSMTC.",
                ["Waiting for Windows Media Player..."]="Warte auf Windows Media Player...",
                ["No artist"]="Kein Interpret",
                ["Winamp and Windows 11 Media Player telemetry and available media variables."]="Winamp- und Windows-11-Media-Player-Telemetrie sowie verfügbare Medienvariablen.",
            ...
            ["fr"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Général",
                ["Media"]="Média", ["Windows 11 media session"]="Session média Windows 11", ["Integrated directly with Windows"]="Intégré directement à Windows", ["Create playback page"]="Créer une page de lecture", ["Winamp plug-in"]="Plug-in Winamp", ["Page variables"]="Variables de page",
                ["Windows Media Player"]="Windows Media Player",
                ["Windows Media Now Playing"]="Windows Media – Lecture en cours",
                ["Windows media session"]="Session média Windows",
                ["No plug-in is required; telemetry comes directly from Windows GSMTC."]="Aucun plug-in n’est requis ; la télémétrie provient directement de Windows GSMTC.",
                ["Waiting for Windows Media Player..."]="En attente de Windows Media Player...",
                ["No artist"]="Aucun artiste",
                ["Winamp and Windows 11 Media Player telemetry and available media variables."]="Télémétrie Winamp et Windows 11 Media Player ainsi que variables média disponibles.",
            ...
            ["tr"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Genel",
                ["Media"]="Medya", ["Windows 11 media session"]="Windows 11 medya oturumu", ["Integrated directly with Windows"]="Doğrudan Windows ile entegre", ["Create playback page"]="Oynatma sayfası oluştur", ["Winamp plug-in"]="Winamp eklentisi", ["Page variables"]="Sayfa değişkenleri",
                ["Windows Media Player"]="Windows Media Player",
                ["Windows Media Now Playing"]="Windows Media – Şimdi Çalıyor",
                ["Windows media session"]="Windows medya oturumu",
                ["No plug-in is required; telemetry comes directly from Windows GSMTC."]="Eklenti gerekmez; telemetri doğrudan Windows GSMTC üzerinden gelir.",
                ["Waiting for Windows Media Player..."]="Windows Media Player bekleniyor...",
                ["No artist"]="Sanatçı yok",
                ["Winamp and Windows 11 Media Player telemetry and available media variables."]="Winamp ve Windows 11 Media Player telemetrisi ve kullanılabilir medya değişkenleri.",
            ...
            ["ru"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Общее",
                ["Media"]="Медиа", ["Windows 11 media session"]="Медиа-сеанс Windows 11", ["Integrated directly with Windows"]="Прямая интеграция с Windows", ["Create playback page"]="Создать страницу воспроизведения", ["Winamp plug-in"]="Плагин Winamp", ["Page variables"]="Переменные страницы",
                ["Windows Media Player"]="Windows Media Player",
                ["Windows Media Now Playing"]="Windows Media — Сейчас играет",
                ["Windows media session"]="Медиа-сеанс Windows",
                ["No plug-in is required; telemetry comes directly from Windows GSMTC."]="Плагин не требуется; телеметрия поступает напрямую через Windows GSMTC.",
                ["Waiting for Windows Media Player..."]="Ожидание Windows Media Player...",
                ["No artist"]="Нет исполнителя",
                ["Winamp and Windows 11 Media Player telemetry and available media variables."]="Телеметрия Winamp и Windows 11 Media Player и доступные медиа-переменные.",
