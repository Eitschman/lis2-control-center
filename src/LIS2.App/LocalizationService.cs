    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ["de"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Allgemein",
                ["Media"]="Medien", ["Windows 11 media session"]="Windows-11-Mediensitzung", ["Create playback page"]="Wiedergabeseite erstellen", ["Winamp plug-in"]="Winamp-Plug-in", ["Page variables"]="Seitenvariablen",
            ...
            ["fr"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Général",
                ["Media"]="Média", ["Windows 11 media session"]="Session média Windows 11", ["Create playback page"]="Créer une page de lecture", ["Winamp plug-in"]="Plug-in Winamp", ["Page variables"]="Variables de page",
                ["Windows Media Player"]="Windows Media Player",
            ...
            ["tr"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Genel",
                ["Media"]="Medya", ["Windows 11 media session"]="Windows 11 medya oturumu", ["Create playback page"]="Oynatma sayfası oluştur", ["Winamp plug-in"]="Winamp eklentisi", ["Page variables"]="Sayfa değişkenleri",
                ["Windows Media Player"]="Windows Media Player",
            ...
            ["ru"] = new(StringComparer.Ordinal)
            {
                ...
                ["General"]="Общее",
                ["Media"]="Медиа", ["Windows 11 media session"]="Медиа-сеанс Windows 11", ["Create playback page"]="Создать страницу воспроизведения", ["Winamp plug-in"]="Плагин Winamp", ["Page variables"]="Переменные страницы",
                ["Windows Media Player"]="Windows Media Player",
